            ...
            authorizeRequests ->
                authorizeRequests
                    ...
                    .antMatchers(ALL_PERMIT_URL).permitAll()
                        ...
                        .antMatchers("/chandler/**").hasAnyRole("ASSISTANT_SUPERINTENDENT","ADMIN")
                        .antMatchers("/ChandlerLicense/**").hasAnyRole("ASSISTANT_SUPERINTENDENT")
                        .antMatchers("/item/**").hasAnyRole("GUARD")
                        .antMatchers("/payment/**").hasAnyRole("SHIP_AGENT","SUPERINTENDENT","CHANDLER")
                        .antMatchers("/role/**").hasAnyRole("ADMIN")
                        .antMatchers("/shipAgent/**").hasAnyRole("ASSISTANT_SUPERINTENDENT","ADMIN")
                        .antMatchers("/user/**").hasAnyRole("ADMIN")
                        .antMatchers("/userDetails/**").hasAnyRole("ADMIN","SUPERINTENDENT")
