...
public class PaymentController {
    ...
    public String addComponent(@Valid @ModelAttribute Payment payment, BindingResult result, Model model) {
        ...
        if (paymentDb.getStatusConformation().equals(StatusConformation.PAIDSHIPAGENT)) {
            List<VesselOrderItemBidPayment> vesselOrderItemBidPayments = vesselOrderItemBidPaymentService.findByPayment(paymentDb);
          System.out.println(" size of "+vesselOrderItemBidPayments.size());
            vesselOrderItemBidPayments.forEach(x -> {
